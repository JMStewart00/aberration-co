      ...
      <div id="main">
        <div className="container">
          <div className="row justify-content-center text-center py-5">
            <h2 id="about" className="splash">About</h2>
        ...
        <div className="container">
          <div className="row justify-content-center text-center py-5">
            <h2 id="culture" className="splash">Drive Culture</h2>
        ...
        <div className="container">
          <div className="row justify-content-center text-center py-5">
            <h2 id="personality" className="splash">Big Personality</h2>
        ...
        <div className="container">
          <div className="row justify-content-center text-center py-5">
            <h2 id="different" className="splash">Be Different</h2>
        ...
        <div className="container">
          <div className="row justify-content-center text-center py-5">
            <h2 id="grit" className="splash">Relentless Grit</h2>
